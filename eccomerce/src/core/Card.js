...
const showRemoveButton=(showRemoveProductButton)=>{
    return(
        ...
        showRemoveProductButton && ( <Link to='/'>
            <button className="btn btn-outline-danger mt-2 mb-2" onClick= {removeFromCard}>
                Remove Product
            </button>
            </Link> 
        )
...
const showStock = quantity =>{
         return quantity > 0 ? (<span className="badge badge-primary-pill">In Stock</span>
         ):(
